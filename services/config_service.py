...
class ConfigService:
    def __init__(self):
        ...
        self.vector_db_path = ".\\db\\chroma_db"
        self.vector_db_collection = "mentalist"

        self.database_filename = ".\\db\\mentalist.sqlite3"
        ...
        self.keywords_context_size = 4096
        self.keywords_temperature = 0.1
        self.embeddings_model = "nomic-embed-text"

        self.similar_posts_max_distance = 0.4
        self.similar_posts_max_number = 30
        self.similar_topics_max_distance = 0.3
        self.similar_topics_for_rating_max_distance = 0.5
        self.similar_topics_for_rating_max_number = 30
